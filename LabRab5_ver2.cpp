...
// Вторая версия программы с некоторыми микроскопическими изменениями в структуре,
// которые помогут не извергать пламя из анального отверстия при выполнении 6 лабораторной работы
...
//*(155-159) Определение деструктора для освобождения контекста устройств                                                           
Figure::~Figure()
{
	ReleaseDC(hWnd, hdc);
}
